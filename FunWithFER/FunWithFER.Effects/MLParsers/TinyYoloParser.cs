...
namespace FunWithFER.Effects.MLParsers
{
    internal class TinyYoloParser
    {
        ...
        internal IList<BoundingBox> ParseOutputs(float[] yoloModelOutputs, float threshold = .3F)
        {
        ...
        internal IList<BoundingBox> NonMaxSuppress(IList<BoundingBox> boxes, int limit, float threshold)
        {
